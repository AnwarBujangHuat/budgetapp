...
abstract class AppLocalizations {
  ...
  /// No description provided for @importTransaction.
  ///
  /// In en, this message translates to:
  /// **'Import Transaction'**
  String get importTransaction;
  ...
  /// No description provided for @confirmationAddNewTransaction.
  ///
  /// In en, this message translates to:
  /// **'Do You Want To Add New Transaction'**
  String get confirmationAddNewTransaction;
  ...
  /// No description provided for @pleaseSelectTag.
  ///
  /// In en, this message translates to:
  /// **'Please Select a Tag'**
  ...
  /// No description provided for @confirmationDialog.
  ///
  /// In en, this message translates to:
  /// **'Confirm?'**
  ...
  /// No description provided for @successAddTransaction.
  ///
  /// In en, this message translates to:
  /// **'Yay, A New Transaction Has Been Added'**
  String get successAddTransaction;
